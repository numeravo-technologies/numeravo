  ...
  return (
    <CalculatorPageShell showBottomSearch={false}>
      ...
      />
        ...
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">
              Plan your concrete short-load cost.
            </h1>
            <p className="mt-5 max-w-3xl text-lg leading-8 text-[#A0AEC0]">
              Estimate the extra charge for small ready-mix orders and compare short-load
              fees, supplier minimums, and bagged concrete. Use the connected workflow for
              the full job, or calculate the delivery surcharge here by itself.
            </p>
        ...
        <div id="short-load-calculator" className="mt-10 scroll-mt-28">
