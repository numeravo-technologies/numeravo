  ...
  return (
    <CalculatorPageShell showBottomSearch={false}>
      ...
      />
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">
              Plan and price your concrete driveway.
            </h1>
            <p className="mt-5 max-w-3xl text-lg leading-8 text-[#A0AEC0]">
              Estimate concrete cubic yards, slab thickness, gravel base, reinforcement,
              waste, delivery, labor, finishing, and total driveway cost. Use the connected
              project workflow when you want to build the full job scope, or calculate the
              driveway here for a quick estimate.
            </p>
        ...
        <div id="driveway-calculator" className="mt-10 scroll-mt-28">
